...
1. Set up personal collection.
2. Choose tea and teaware.
3. Conduct brewing session.
4. Save and repeat practice.

## MVP Stories

| Priority | Story |
| --- | --- |
| Must | As a collector, I want to add a tea so I can remember what I own. |
| Must | As a collector, I want to track remaining quantity so I know what is available. |
...
- As a beginner, I want guided lessons.
